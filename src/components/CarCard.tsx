      ...
      >
        ...
        <div className="p-5">
          ...
          <p className="mt-5 text-xl font-bold text-zinc-900">
            R${" "}
            {carro.preco_a_partir_rs.toLocaleString("pt-BR")}
          </p>

          <div className="mt-5 grid gap-3">
            <Link
              href={`/carros/${carro.id}`}
              className="flex items-center justify-center rounded-xl bg-zinc-900 px-5 py-3 text-sm font-semibold text-white transition hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-zinc-900 focus:ring-offset-2"
            >
              Ver detalhes
            </Link>
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <button
                ...
                className={`flex items-center justify-center rounded-xl border px-5 py-3 text-sm font-semibold transition focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 ${
                  selecionado
              ...
              <button
                type="button"
                onClick={abrirModal}
                className="flex items-center justify-center rounded-xl bg-blue-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2"
              >
                Tenho interesse
              </button>
            </div>
